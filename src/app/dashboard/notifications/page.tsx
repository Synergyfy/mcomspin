...
export default function NotificationsPage() {
  ...
  const alerts = [
    { type: 'Campaign Alert', desc: 'Notify when a campaign starts or ends.', enabled: true },
    { type: 'Reward Alert', desc: 'Notify customers when they win a reward.', enabled: true },
    { type: 'Expiry Reminder', desc: 'Send reminders 24h before a reward expires.', enabled: false },
  ];
      ...
      <section className="bg-white rounded-[40px] border border-[#eee] p-8 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end">
            <button className="px-8 py-3 bg-[#f97316] text-white rounded-2xl font-bold text-[13px] hover:bg-[#ea580c] transition-all shadow-lg shadow-[#f97316]/20">
              Send to 1,295 Customers
            </button>
          </div>
        </div>
      </section>
