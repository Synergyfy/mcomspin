...
const mockCustomers: Customer[] = [
  { id: '1', name: 'James Wilson', phone: '+44 7700 900123', email: 'james.w@example.com', rewardsWon: 12, rewardsRedeemed: 8, lastVisit: '2 hours ago', status: 'Returning' },
  { id: '2', name: 'Sarah Chen', phone: '+44 7700 900456', email: 'sarah.c@example.com', rewardsWon: 5, rewardsRedeemed: 5, lastVisit: 'Yesterday', status: 'Returning' },
  { id: '3', name: 'Marcus Thorne', phone: '+44 7700 900789', email: 'm.thorne@example.com', rewardsWon: 1, rewardsRedeemed: 0, lastVisit: '3 days ago', status: 'New' },
  { id: '4', name: 'Elena Rodriguez', phone: '+44 7700 900321', email: 'elena.r@example.com', rewardsWon: 24, rewardsRedeemed: 22, lastVisit: 'Just now', status: 'Returning' },
  { id: '5', name: 'David Smith', phone: '+44 7700 900654', email: 'd.smith@example.com', rewardsWon: 3, rewardsRedeemed: 1, lastVisit: '1 week ago', status: 'New' },
];
