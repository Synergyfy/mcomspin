        ...
        <div className="lg:col-span-2">
            ...
            <section className="bg-white rounded-[40px] border border-[#eee] p-8 shadow-sm space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" defaultValue="MCOM Coffee Co." className="w-full bg-[#fafaf9] border border-[#f0f0ee] rounded-2xl px-4 py-3 text-[14px] outline-none focus:border-[#f97316] transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-[11px] font-bold text-[#aaa] uppercase tracking-widest">Industry</label>
                  <select className="w-full bg-[#fafaf9] border border-[#f0f0ee] rounded-2xl px-4 py-3 text-[14px] outline-none appearance-none">
                ...
                <div className="md:col-span-2 space-y-2">
                  ...
                  <textarea defaultValue="Premium coffee shop in the heart of London." className="w-full bg-[#fafaf9] border border-[#f0f0ee] rounded-2xl px-4 py-3 text-[14px] outline-none focus:border-[#f97316] transition-all h-24 resize-none" />
                </div>
                <div className="space-y-2">
                  <label className="text-[11px] font-bold text-[#aaa] uppercase tracking-widest">Phone</label>
                  <input type="text" defaultValue="+44 20 7123 4567" className="w-full bg-[#fafaf9] border border-[#f0f0ee] rounded-2xl px-4 py-3 text-[14px] outline-none focus:border-[#f97316] transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-[11px] font-bold text-[#aaa] uppercase tracking-widest">Email</label>
                  <input type="email" defaultValue="hello@mcomcoffee.com" className="w-full bg-[#fafaf9] border border-[#f0f0ee] rounded-2xl px-4 py-3 text-[14px] outline-none focus:border-[#f97316] transition-all" />
                </div>
              </div>
              <div className="flex justify-end pt-4">
                <button className="px-8 py-3 bg-[#1a1a1a] text-white rounded-2xl font-bold text-[13px] hover:bg-[#f97316] transition-all shadow-lg">Save Changes</button>
              </div>
            </section>
          )}
          ...
          {activeTab === 'Branding' && (
            <section className="bg-white rounded-[40px] border border-[#eee] p-8 shadow-sm space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <input type="text" defaultValue="#f97316" className="flex-1 bg-[#fafaf9] border border-[#f0f0ee] rounded-2xl px-4 py-3 text-[14px] font-mono outline-none" />
                  </div>
                </div>
              </div>
              <div className="space-y-4">
              ...
              <div className="flex justify-end pt-4">
                <button className="px-8 py-3 bg-[#1a1a1a] text-white rounded-2xl font-bold text-[13px] hover:bg-[#f97316] transition-all shadow-lg">Save Branding</button>
              </div>
            </section>
          )}
              ...
              <div className="space-y-6">
                ...
                <div className="pt-8 border-t border-[#f5f5f3]">
                  ...
                  <div className="space-y-3">
                    {[
                      { device: 'MacBook Pro • London, UK', time: 'Just now', active: true },
                      { device: 'iPhone 15 • London, UK', time: '2 hours ago', active: false },
                    ].map((session, i) => (
          ...
          <section className="bg-[#1a1a1a] rounded-[40px] p-8 text-white">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-[15px] font-bold mt-1">Starter Monthly</p>
              </div>
              <div>
                <p className="text-[11px] font-bold text-white/40 uppercase tracking-widest">Member Since</p>
                <p className="text-[15px] font-bold mt-1">March 2024</p>
              </div>
