  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button className="px-5 py-2.5 bg-[#1a1a1a] text-white rounded-2xl text-[13px] font-bold hover:bg-[#f97316] transition-all shadow-lg flex items-center gap-2">
        ...
        {locations.map((loc) => (
          <div key={loc.id} className="bg-white rounded-[32px] border border-[#eee] p-6 shadow-sm group hover:border-[#f97316]/30 transition-all relative overflow-hidden">
            ...
            <div className="mt-8 pt-6 border-t border-[#f5f5f3] flex items-center gap-3">
              <button className="flex-1 py-2.5 bg-[#f5f5f3] hover:bg-[#eee] text-[#1a1a1a] text-[12px] font-bold rounded-xl transition-colors">
                Edit
              </button>
              <button className="px-4 py-2.5 text-red-500 hover:bg-red-50 rounded-xl text-[12px] font-bold transition-colors">
